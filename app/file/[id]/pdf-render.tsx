...
import { Donut, FileText, LoaderCircle, LoaderPinwheel } from 'lucide-react';
...
const PdfRenderPage = ({ pdfUrl }: PdfRenderPageProps) => {
  ...
  return (
    ...
    >
      <div className='overflow-auto overflow-x-hidden h-[calc(100dvh-5rem)] max-h-calc(100dvh-5rem)] pt-4 pb-2'>
